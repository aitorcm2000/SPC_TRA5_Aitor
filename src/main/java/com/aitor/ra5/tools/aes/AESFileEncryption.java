...
public class AESFileEncryption extends AESKeyGen{
    ...
    /**
     * This version is for AES exclusive encryption
     * 
     * 
     * @param ogFile
     * @param pswd
    ...
    /**
     * This version is for mixed encryption with RSA
     * 
     * 
     * @param ogFile
     * @param sk
     * @param keySize 
     */
    public void fileEncryption(File ogFile , SecretKey sk){
    ...
    public void fileDecryption (File encFile, String pswd, int keySize){
     ...
     * @param sk 
     */
    public void fileDecryption (File encFile, SecretKey sk){
        File ogFile = new File(encFile.getAbsolutePath().replace(".enc", ""));
